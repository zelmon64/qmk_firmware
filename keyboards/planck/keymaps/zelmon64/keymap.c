 ...
 * |      |      |      |      |      |      |      |      | Mute | Back | Vol+ | Fwd  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      | Media Select|      | Play | Prev | Vol- | Next |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWERM] = {
  {KC_EJCT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______},
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______},
  {_______, _______, _______, _______, _______, _______, _______, _______, KC_MUTE, KC_BTN4, KC_VOLU, KC_BTN5},
  {_______, _______, _______, _______, _______, KC_MSEL, KC_MSEL, _______, KC_MPLY, KC_MPRV, KC_VOLD, KC_MNXT}
},
