...
[_CMODDH] = {
  ...
  {MOUSE,          KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT       }
},
...
[_LOWER] = {
  ...
  {_______, _______, _______, _______, _______, _______, _______, _______, S(KC_NUBS), KC_MPRV, KC_VOLD, KC_MNXT}
},
 ...
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |      |      |      | Pg Up| Mute |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      |   \  | Home | Pg Dn| End  |
 * `-----------------------------------------------------------------------------------'
 */
[_RAISE] = {
  ...
  {_______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, _______, KC_PGUP, KC_MUTE},
...
[_MOUSE] = {
  ...
  {CMODDH,  KC_P0, KC_P0, KC_PDOT, _______, KC_PENT, KC_PENT, _______, _______, KC_MS_L, KC_MS_D, KC_MS_R}
},
